            ...
            {comparingPolicies[0] ? (
              <div className="space-y-1 pr-4">
                ...
                <h4
                  ...
                  title={comparingPolicies[0].title}
                >
                  {comparingPolicies[0].title}
                </h4>
                <p className="text-[9px] text-slate-400 font-semibold">
                  ({comparingPolicies[0].region})
                </p>
                <button
                  type="button"
          ...
          <div className="col-span-5 text-left relative min-h-[56px] flex flex-col justify-center">
            {comparingPolicies[1] ? (
              <div className="space-y-1 pr-4">
                ...
                <h4
                  className="line-clamp-2 text-[10px] font-bold text-slate-700 leading-normal"
                  title={comparingPolicies[1].title}
                >
                  {comparingPolicies[1].title}
                </h4>
                <p className="text-[9px] text-slate-400 font-semibold">
                  ({comparingPolicies[1].region})
                </p>
                <button
                  type="button"
            ...
            >
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="grid grid-cols-12 gap-4">
                  ...
                  <div className="col-span-4 text-xs text-slate-700 text-left">
                    {comparingPolicies[0].target}
                  </div>
                  <div className="col-span-5 text-xs text-slate-700 text-left">
                    {comparingPolicies[1].target}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-12 gap-4">
                  ...
                  <div className="col-span-4 text-[10px] text-slate-600 text-left space-y-1.5 leading-relaxed">
                    {comparingPolicies[0].details.map((d) => (
                      <p key={`${comparingPolicies[0].id}-${d}`}>• {d}</p>
                    ))}
                  </div>
                  <div className="col-span-5 text-[10px] text-slate-600 text-left space-y-1.5 leading-relaxed">
                    {comparingPolicies[1].details.map((d) => (
                      <p key={`${comparingPolicies[1].id}-${d}`}>• {d}</p>
                    ))}
                  </div>
                </div>
              </div>
