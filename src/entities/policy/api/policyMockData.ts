...
export const MOCK_POLICY_DTOS: PolicyDto[] = [
  ...
  },
  {
    ...
    details: [
      ...
      '자격조건: 만 19세~34세 대학 졸업(예정)자 및 미취업 청년, 공학계열 전공자 한정',
  ...
  },
  {
    ...
    logoType: 'job',
    details: [
      '지원내용: 사업화 자금 최대 5천만원 및 전담 멘토 1:1 컨설팅 제공',
      '자격조건: 만 19세 이상 39세 이하 예비 창업자 및 창업 3년 이내 대표',
      '선발방식: 사업계획서 서류 심사 및 발표 평가',
    ],
  ...
  },
  {
    ...
    logoType: 'heart',
    details: [
      '지원내용: 월 대중교통 지출액의 30%를 익월 환급 (최대 60회 한도)',
      '자격조건: 만 19세 이상 34세 이하 K-패스 카드 발급자',
      '신청방법: K-패스 앱 또는 카드사 홈페이지에서 청년 등급 등록',
    ],
  ...
  },
  {
    ...
    logoType: 'home',
    details: [
      '지원내용: 전세자금 대출 이자의 연 최대 2%p 차액 보전',
      '자격조건: 경기도 거주 무주택 미혼 청년 중 소득 기준 충족자',
      '대출한도: 임차보증금 3억원 이하 주택',
    ],
  ...
  },
  {
    ...
    logoType: 'hand',
    details: [
      '지원내용: 활동비 지급 및 정책 제안 채택 시 인센티브 제공',
      '자격조건: 만 19세 이상 34세 이하 청년 누구나 지원 가능',
      '활동기간: 6개월, 월 1회 정기 회의 참석 필수',
    ],
