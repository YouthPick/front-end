...
import { Policy, FilterState, UserProfile, TrackerItem, TrackerChecklistItem } from "./types";
      ...
      <main className="mx-auto flex-1 w-full max-w-7xl px-4 py-8 sm:px-6">
          ...
          <div className="space-y-10 animate-in fade-in duration-300">
            ...
            <section className="space-y-4" id="category-section">
              <div className="text-left">
                ...
                <p className="text-[11px] text-slate-400 mt-0.5">원하시는 주요 분야별 정책 카테고리를 눌러 빠르게 상세 필터 탐색을 시작해 보세요.</p>
              </div>
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
                {[
                  { key: "일자리", title: "일자리", subtitle: "취업・창업 지원", bg: "bg-primary/10 text-primary hover:bg-primary/20", icon: Briefcase },
                  { key: "주거", title: "주거", subtitle: "주거・금융 지원", bg: "bg-blue-50 text-blue-600 hover:bg-blue-100/50", icon: HomeIcon },
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pb-4 border-b border-slate-100">
                  <div>
                    ...
                    <p className="text-[11px] text-slate-400 mt-1">
                      현재 프로필: <span className="font-bold text-primary">{userProfile.region} {userProfile.subRegion} · {userProfile.employmentStatus} · {userProfile.educationStatus}</span>
                    </p>
                  </div>
                  <button
                    onClick={() => {
              ...
              <div className="lg:col-span-8 space-y-6">
                <div className="flex items-center justify-between">
                  <div className="text-left">
                    ...
                    <p className="text-[10px] text-slate-400 mt-0.5">전국 및 서울 등 청년들이 가장 집중해서 조회하는 핵심 소식입니다.</p>
                  </div>
                  <button onClick={() => navigateTo("search")} className="text-xs font-bold text-slate-400 hover:text-slate-700">전체보기</button>
                </div>
        ...
        {activeView === "search" && (
          <div className="space-y-6 animate-in fade-in duration-300">
            <div className="text-left space-y-1">
              ...
              <p className="text-xs text-slate-400">조건 필터와 지역 정보를 조합하여 나에게 딱 맞는 혜택 사업을 세밀하게 타겟팅해 보세요.</p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pt-2 text-left">
              <div>
                <span className="text-xs text-slate-500 font-semibold">
                  총 <span className="text-primary font-bold">{filteredPolicies.length}건</span>의 청년 정책이 정밀 필터링되었습니다.
                </span>
              </div>
              <div className="flex items-center space-x-1">
                <span className="text-[10px] font-bold text-slate-400">보기 구분:</span>
                <button 
                  onClick={() => setFilters({ region: "전체", status: "전체", category: "전체", age: "전체" })}
            ...
            {filteredPolicies.length > 0 ? (
              ...
              <div className="rounded-3xl border-2 border-dashed border-slate-200 bg-white py-16 px-4 text-center space-y-4 max-w-2xl mx-auto">
                ...
                <h3 className="text-sm font-extrabold text-slate-700">일치하는 검색 결과가 전혀 없습니다</h3>
                    ...
                    <div className="rounded-2xl bg-slate-50 p-4 space-y-3">
                      <div className="space-y-1.5">
                        ...
                        <div className="space-y-1 text-xs text-slate-600 font-semibold">
                          <p className="flex items-center text-emerald-600"><Check className="h-3.5 w-3.5 mr-1 shrink-0" />{reasons[0]} <span className="text-[10px] text-slate-400 ml-1">(+25)</span></p>
                          <p className="flex items-center text-emerald-600"><Check className="h-3.5 w-3.5 mr-1 shrink-0" />{reasons[1]} <span className="text-[10px] text-slate-400 ml-1">(+20)</span></p>
                          <p className="flex items-center text-emerald-600"><Check className="h-3.5 w-3.5 mr-1 shrink-0" />{reasons[2]} <span className="text-[10px] text-slate-400 ml-1">(+15)</span></p>
                        </div>
                      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              ...
              <div className="lg:col-span-5 space-y-5 text-left">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-slate-400">관심 등록한 정책의 제출 기한, 구비 서류 체크리스트를 놓치지 않게 체계적으로 추적합니다.</p>
                </div>
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-[10px] text-slate-400 font-bold">목표: {track.targetDate}</span>
                          </div>

                          <h4 className="text-xs font-extrabold text-slate-800 mt-2 line-clamp-1">{policyRef.title}</h4>
                          
                          {/* Progress bar */}
                          <div className="mt-3 space-y-1">
                            <div className="flex justify-between text-[10px] font-extrabold text-slate-400">
                              <span>체크리스트 {completedItems}/{totalItems} 완료</span>
                              <span>{pct}%</span>
                            </div>
                  ...
                  <div className="rounded-3xl border border-slate-100 bg-white p-6 text-left space-y-6 shadow-sm">
                    ...
                    <div className="flex items-start justify-between pb-4 border-b border-slate-100">
                      <div className="space-y-1">
                        ...
                        <h3 className="text-sm font-black text-slate-800 leading-tight pr-6">{activeTrackerPolicy.title}</h3>
                      </div>
                      <a
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="block text-[10px] font-extrabold text-slate-400 uppercase">신청 상태 변경</label>
                        <select
                          value={activeTrackerItem.status}
                          onChange={(e) => handleUpdateTrackerStatus(activeTrackerItem.policyId, e.target.value as any)}
                      ...
                      <div className="space-y-1.5">
                        <label className="block text-[10px] font-extrabold text-slate-400 uppercase">목표 마감일 설정</label>
                        <input
                          type="date"
                          value={activeTrackerItem.targetDate}
                          onChange={(e) => handleUpdateTrackerDate(activeTrackerItem.policyId, e.target.value)}
                    ...
                    <div className="rounded-2xl bg-slate-50 p-4 border border-slate-100 space-y-2">
                      <h4 className="text-[10px] font-extrabold text-slate-400 uppercase tracking-wider">정책 제출 서류 기본 안내</h4>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-1.5">
                        {activeTrackerItem.checklist.map((item) => (
                          ...
                          >
                            <button
                              onClick={() => handleToggleChecklistItem(activeTrackerItem.policyId, item.id)}
                            ...
                            <button
                              onClick={() => handleDeleteChecklistItem(activeTrackerItem.policyId, item.id)}
                    ...
                    <div className="space-y-2">
                      <label className="block text-xs font-extrabold text-slate-800">개인 업무 및 보완 기록 메모</label>
                      <textarea
                        rows={4}
                        maxLength={2000}
        ...
        {activeView === "mypage" && (
          <div className="space-y-6 animate-in fade-in duration-300 max-w-3xl mx-auto">
            ...
            <div className="rounded-3xl bg-white border border-slate-100 p-6 text-left space-y-4 shadow-sm">
              ...
              <div className="space-y-3.5 text-xs text-slate-600">
                <div className="grid grid-cols-4 gap-2">
                  ...
                  <span className="col-span-3 font-extrabold text-slate-800">{userProfile.region} {userProfile.subRegion}</span>
                </div>
                <div className="grid grid-cols-4 gap-2">
                  <span className="text-slate-400 font-bold">출생연도</span>
                  <span className="col-span-3 font-extrabold text-slate-800">{userProfile.birthYear}년생</span>
                </div>
                <div className="grid grid-cols-4 gap-2">
                  <span className="text-slate-400 font-bold">현재 취업상태</span>
                  <span className="col-span-3 font-extrabold text-slate-800">{userProfile.employmentStatus}</span>
                </div>
                <div className="grid grid-cols-4 gap-2">
                  <span className="text-slate-400 font-bold">최종 학력수준</span>
                  <span className="col-span-3 font-extrabold text-slate-800">{userProfile.educationStatus}</span>
                </div>
                <div className="grid grid-cols-4 gap-2">
                  ...
                  <span className="col-span-3 flex flex-wrap gap-1 font-bold text-slate-700">
                    {userProfile.interests.map((it) => (
                      <span key={it} className="bg-slate-100 px-2 py-0.5 rounded-md text-[10px]">{it}</span>
                    ))}
                  </span>
                </div>
              </div>
            ...
            <div className="rounded-3xl bg-white border border-slate-100 p-6 text-left space-y-4 shadow-sm">
              <h4 className="text-xs font-extrabold text-slate-800 border-b border-slate-100 pb-3">보관중인 관심 정책 목록 ({savedPolicyIds.length}건)</h4>
              <div className="space-y-3">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex items-start justify-between">
                        <div className="space-y-1">
                          <div className="flex items-center space-x-1.5">
                            ...
                            <span className="text-[10px] text-slate-400 font-bold">{policyRef.region}</span>
                          </div>
                      ...
                      {policyRef.isSourceMissing ? (
                        ...
                        <p className="text-[11px] text-slate-500 leading-relaxed">{policyRef.description}</p>
                      )}
            ...
            {showDeleteAccountConfirm && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
                <div className="w-full max-w-sm rounded-3xl bg-white p-6 shadow-xl text-left space-y-4">
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed">
                    탈퇴 완료 시 Google 간편인증 연동이 해제되며, 그동안 기획관리 중이던 **{trackers.length}건의 신청 기한 타임라인 및 {savedPolicyIds.length}건의 관심 저장 목록**이 즉각적으로 복구 불가능하게 안전 소멸 처리됩니다.
                  </p>
            ...
            <div className="rounded-3xl border border-slate-100 bg-white p-6 sm:p-8 text-left space-y-6 shadow-sm">
                ...
                <div className="space-y-5 animate-in fade-in duration-200">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      onChange={(e) => setWizardProfile({ ...wizardProfile, birthYear: parseInt(e.target.value) })}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        onChange={(e) => setWizardProfile({ ...wizardProfile, region: e.target.value })}
                        className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-xs font-bold text-slate-700 outline-none"
                      >
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        onChange={(e) => setWizardProfile({ ...wizardProfile, subRegion: e.target.value })}
                        className="w-full rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 text-xs font-bold text-slate-700 outline-none"
                      >
                      ...
                      {[
                        ...
                        return (
                          <button
                            key={status}
                            type="button"
                            onClick={() => setWizardProfile({ ...wizardProfile, employmentStatus: status })}
                      ...
                      {[
                        ...
                        return (
                          <button
                            key={edu}
                            type="button"
                            onClick={() => setWizardProfile({ ...wizardProfile, educationStatus: edu })}
                            className={`rounded-xl border py-2.5 text-xs font-bold transition-all cursor-pointer ${
                              isSelected
                                ? "bg-primary border-primary text-white shadow-sm"
                                : "bg-white border-slate-200 text-slate-600 hover:bg-slate-50"
              ...
              {profileSetupStep === 3 && (
                <div className="space-y-5 animate-in fade-in duration-200">
                  ...
                  <div className="space-y-2">
                    <label className="block text-xs font-extrabold text-slate-400 uppercase tracking-wider">관심 사업 카테고리 (최대 3개)</label>
                  ...
                  <div className="space-y-2">
                    <label className="block text-xs font-extrabold text-slate-400 uppercase tracking-wider">추가 타겟 키워드 (최대 5개)</label>
          ...
          <div className="space-y-6 animate-in fade-in duration-300">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="rounded-2xl border border-slate-100 bg-white p-4.5 text-left shadow-sm">
                <span className="block text-[10px] text-slate-400 font-bold uppercase tracking-wider">전국 활성 청년정책</span>
                <span className="text-xl font-black text-slate-800 block mt-1">3,241건</span>
                <span className="text-[9px] text-emerald-500 font-bold mt-1 block">✓ API 정상 수신 완료</span>
              </div>
              ...
              <div className="rounded-2xl border border-slate-100 bg-white p-4.5 text-left shadow-sm">
                ...
                <span className="text-[9px] text-slate-400 font-bold mt-1 block">메모 유지/백업 카드 노출 중</span>
              </div>

              <div className="rounded-2xl border border-slate-100 bg-white p-4.5 text-left shadow-sm">
                <span className="block text-[10px] text-slate-400 font-bold uppercase tracking-wider">신청기간 날짜 파싱오류</span>
                <span className="text-xl font-black text-rose-500 block mt-1">18건</span>
                <span className="text-[9px] text-rose-400 font-bold mt-1 block">⚠️ 수동 입력 보정 대기</span>
              </div>

              <div className="rounded-2xl border border-slate-100 bg-white p-4.5 text-left shadow-sm">
                <span className="block text-[10px] text-slate-400 font-bold uppercase tracking-wider">공공 DB 접속 실패 수</span>
                <span className="text-xl font-black text-slate-400 block mt-1">2건</span>
                <span className="text-[9px] text-slate-400 font-bold mt-1 block">전회차 크롤러 캐시 가동</span>
              </div>
            </div>
      ...
      <AnimatePresence>
        {selectedPolicy && (
          <DetailModal
            ...
            recommendationScore={selectedPolicy.id === "p1" ? 94 : selectedPolicy.id === "p2" ? 88 : selectedPolicy.id === "p3" ? 82 : 78}
