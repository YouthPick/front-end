...
import { type UserRole, useAuthStore, useProfileStore } from '@/entities/user';
import { ROUTES } from '@/shared/constants';
import { useToast } from '@/shared/ui';
import { getRedirectPath } from '@/shared/utils';

// 소셜 제공자별 mock 이메일. 실제 서비스에서는 OAuth 콜백으로 provider와 email이 함께 내려온다.
const MOCK_EMAIL_BY_PROVIDER: Record<string, string> = {
  카카오: 'mingi.dev@kakao.com',
  네이버: 'mingi.dev@naver.com',
  Google: 'mingi.dev@gmail.com',
};
