import { ArrowRight, Briefcase, Edit3, GraduationCap, Hand, Heart, Home as HomeIcon, Sparkles } from "lucide-react";
  ...
  <section className="space-y-4" id="category-section">
    ...
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
      {[
        ...
        { key: "복지문화", title: "복지・문화", subtitle: "생활・건강・문화", bg: "bg-rose-50 text-rose-600 hover:bg-rose-100/50", icon: Heart },
        { key: "참여권리", title: "참여・권리", subtitle: "참여・권익 보호", bg: "bg-amber-50 text-amber-600 hover:bg-amber-100/50", icon: Hand }
      ].map((item) => {
  ...
  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 pt-4">
    <div className="lg:col-span-8 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button onClick={() => onNavigateSearch()} className="text-xs font-bold text-slate-400 hover:text-slate-700">전체보기</button>
      </div>
