...
interface SearchPagePresenterProps {
  ...
  setFilter: (key: keyof PolicySearchFilters, value: string) => void;
  resetFilters: (options?: { clearQuery?: boolean }) => void;
  submitSearch: () => void;
}

export function SearchPagePresenter({
  query,
  filters,
  totalCount,
  page,
